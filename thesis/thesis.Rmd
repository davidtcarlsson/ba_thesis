...
```{r df1-loss-alphas, fig.cap = "A graphical representation of table x. Here we can see the linear relationship between the degree of asymmetry and MLLE for the different loss functions on data set 1", echo=FALSE}
